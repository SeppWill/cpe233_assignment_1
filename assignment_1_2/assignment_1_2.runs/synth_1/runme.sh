...
HD_PWD='C:/Users/seppl/assignment_1_2/assignment_1_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_Accumulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_Accumulator.tcl
