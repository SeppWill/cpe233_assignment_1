...
HD_PWD='C:/Users/seppl/assignment_1_2/assignment_1_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_Accumulator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RAM_Accumulator.tcl -notrace
