...
HD_PWD='C:/Users/seppl/assignment_1/assignment_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bubble_sort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bubble_sort.tcl
